      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-10">
        <div className="lg:col-span-3 space-y-6">
          <section className="bg-white border border-[#EAEAEA] rounded-xl p-5 shadow-sm">
            ...
            <div className="space-y-4">
              <OptionToggle icon={<Camera />} label="Allow Photo Upload" value={settings.allowPhotoUpload} onChange={(v: boolean) => setSettings({ ...settings, allowPhotoUpload: v })} />
              <OptionToggle icon={<Settings2 />} label="Enable Revisions" value={settings.allowChangeRequests} onChange={(v: boolean) => setSettings({ ...settings, allowChangeRequests: v })} />
              <OptionToggle icon={<MessageSquare />} label="Direct Messaging" value={settings.enableMessaging} onChange={(v: boolean) => setSettings({ ...settings, enableMessaging: v })} />
            </div>
          </section>
